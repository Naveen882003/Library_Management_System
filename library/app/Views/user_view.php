...
<body>
    ...
    <a href="<?php echo base_url('home');?>"><button type="button" class="btn btn-primary">Back</button></a>
        <h1 class=" text-center" style="font-size: 150%; padding-bottom: 20px;padding-top: 10px;">My Books Details
        </h1>
...
<a href=" ' . base_url().'return/'. $row["book_id"] . '"><input  style="margin-right: 10px;"
type="button" id="res" name="res" value="Return" class="btn btn-danger"></a><a href=" ' . base_url().'renew/'. $row["book_id"] . '"><input type="button"
 id="del" name="del" value="Renew" class="btn btn-success"></a></td></tr>';
